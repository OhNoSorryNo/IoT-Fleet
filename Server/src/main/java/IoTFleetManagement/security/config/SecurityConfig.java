...
//                )
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers( "/", "/index.html", "/css/**", "/auth/register", "/csrf-token", "/js/**", "/languages/**", "/auth/login", "/register.html", "/agents/**", "/dashboard.html", "/auth/logout", "/auth/register-admin", "api/invitations/generate", "/v3/api-docs/**","/swagger-ui.html","/swagger-ui/**").permitAll() // Allow anyone to access
